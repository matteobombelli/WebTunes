...
// Short-lived pairing codes for connecting the WebTunes Importer browser
// extension (Settings → YouTube importer). The signed-in user mints a code in
// Settings, types it into the extension, and the extension redeems it for a
...
// Long-lived bearer tokens for the WebTunes Importer extension, issued by
